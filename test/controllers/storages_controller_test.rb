...
class StoragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create storage" do
    assert_difference('Storage.count') do
      post storages_url, params: { storage: { cur_capacity: @storage.cur_capacity, max_capacity: @storage.max_capacity } }
    end
  ...
  test "should update storage" do
    patch storage_url(@storage), params: { storage: { cur_capacity: @storage.cur_capacity, max_capacity: @storage.max_capacity } }
